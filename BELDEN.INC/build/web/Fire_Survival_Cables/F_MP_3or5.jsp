...
<%@page import="addresses.Fire_Survival_Cables" %>
<!DOCTYPE html>
<html>
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <title>Multi Pair 300 or 500V</title>
    </head>
    <body>
 ...
 <img src="../Resources/Styling/belden.jpg" alt="Belden-Logo" style="height:80px;width=5px;float:right"/>
     ...
     FileInputStream file = new FileInputStream(new File(addr.MP3or5));
                XSSFWorkbook workbook = new XSSFWorkbook(file);
                String a; double x; int o;
        %>
              <form action='../F_MP_3or5'>
                <%--FOR CABLETYPE--%>
               ...
               <br>Conductor: <select name='Conductor'>
                ...
                %>
                 ...
                 <%--FOR Type of Copper--%>
               <br>Type Of Copper: <select name='TypeOfCopper'>
                <option name="Bare Copper">Bare Copper</option>
                <option name="Tinned Copper">Tinned Copper</option>
                </select>
               ...
               <br>Shield: <select name='Shield'>
                ...
                %>
                 ...
                 <%--FOR No. Of Pairs--%>
               <br>Number of Pairs: <select name='Pairs'>
