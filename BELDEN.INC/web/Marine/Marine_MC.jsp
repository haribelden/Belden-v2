...
<%@page import="addresses.Marine" %>
<!DOCTYPE html>
<html>
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <title>Marine Multi Core</title>
    </head>
    <body>
 ...
 <img src="../Resources/Styling/belden.jpg" alt="Belden-Logo" style="height:80px;width=5px;float:right"/>
        ...
        <%
            Marine addr = new Marine();
     FileInputStream file = new FileInputStream(new File(addr.MC));
                XSSFWorkbook workbook = new XSSFWorkbook(file);
                String a; double x; int o;
        %>
              <form action='../Marine_MC'>
                <%--FOR CABLETYPE--%>
