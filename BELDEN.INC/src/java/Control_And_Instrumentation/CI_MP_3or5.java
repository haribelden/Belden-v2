 ...
 * @author axv01011
 */
public class CI_MP_3or5 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Multi Pair 300 or 500V</title>");            
            out.println("</head>");
            out.println("<body>");
          Control_And_Instrumentation addr = new Control_And_Instrumentation();
            try (  FileInputStream file = new FileInputStream(new File(addr.MP3or5))) {
