 ...
 * @author axv01011
 */
public class F_MC_3or5 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Fire Multi Core 300 or 500V</title>");            
            out.println("</head>");
            out.println("<body>");
  ...
  partcode.setDescription(description);
                ...
                while (rowIterator.hasNext()) 
                {
                  ...
                  out.println("<br>");
                out.println(description);  String pc = partcode.getCompletePC();
