 ...
 */
package Control_And_Instrumentation;
 ...
 * @author axv01011
 */
public class CI_MC_3or5 extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
           out.println("<!DOCTYPE html>");
            ...
            try (FileInputStream file = new FileInputStream(new File(addr.MC3or5))) {
                ...
                String description= s6+","+s1+","+s2+","+s3+","+s4+","+s5+","+s7;
                ...
                while (rowIterator.hasNext()) 
                {
                        ...
                        switch (cell.getCellType()) 
                    {
                        ...
                        out.println(c3);
                        partcode.setInsulation_or_jacket(c3);
                    }
                }
                ...
                while (rowIterator.hasNext()) 
                {
                        ...
                        switch (cell.getCellType()) 
                    {
                        ...
                        out.println(c4);
                        partcode.setInsulation_color(c4);
                    }
                }
               ...
               String description1=partcode.getDescription();
                ...
                out.println("<input type='hidden' value='Control & Intrumentation' name='category'>"); //NEW
                out.println("<input type='text' name='deviation'>");  //NEW
