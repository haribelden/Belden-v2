 ...
 * @author axv01011
 */
public class CI_MT_6or10 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Multi Triads 600 or 1000V</title>");            
            out.println("</head>");
            out.println("<body>");
            Control_And_Instrumentation addr = new Control_And_Instrumentation();
            try (  FileInputStream file = new FileInputStream(new File(addr.MT6or10))) {
                ...
                s6=request.getParameter("Triads");
