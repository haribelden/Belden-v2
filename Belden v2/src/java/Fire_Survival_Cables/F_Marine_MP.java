 ...
 * @author axv01011
 */
public class F_Marine_MP extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Multi Pair Marine</title>");            
            out.println("</head>");
            out.println("<body>");
          Fire_Survival_Cables addr = new Fire_Survival_Cables();
            try (  FileInputStream file = new FileInputStream(new File(addr.MarineMP))) {
