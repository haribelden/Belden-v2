 ...
 * @author axv01011
 */
public class Marine_MT extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Marine Multi Triads</title>");            
            out.println("</head>");
            out.println("<body>");
            Marine addr = new Marine();
            try (  FileInputStream file = new FileInputStream(new File(addr.MT))) {
