...
<html>
    <head>
        ...
        <title>Multi Core 300 or 500V</title>
    </head>
    <body>
 ...
 <img src="../Resources/Styling/belden.jpg" alt="Belden-Logo" style="height:80px;width=5px;float:right"/>
     ...
     FileInputStream file = new FileInputStream(new File(addr.MC3or5));
                XSSFWorkbook workbook = new XSSFWorkbook(file);
                String a; double x; int o;
        %>
              <form action='../F_MC_3or5'>
                <%--FOR CABLETYPE--%>
               ...
               <br>Shield: <select name='Shield'>
                ...
                %>
                 ...
                 <%--FOR No. Of Cores--%>
               <br>Number of Cores: <select name='Cores'>
